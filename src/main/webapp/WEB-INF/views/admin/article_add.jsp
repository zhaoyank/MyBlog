    ...
    <section class="content">
      ...
      <div class="box box-primary">
          <div class="container">
            ...
            <form action="/admin/article/add" method="post" class="form-horizontal" id="postForm">
              <br>
               ...
               <div class="form-group">
                  <input type="text" class="form-control" name="label" placeholder="请为主题贴上标签，多个标签使用，号分开">
               </div>
               <div class="form-group"> 
               ...
               <br>
               <div class="form-group">
                  <button class="btn btn-primary" id="postBtn">发布文章</button>
               </div>
            </form>
